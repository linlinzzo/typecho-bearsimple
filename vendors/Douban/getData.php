...
$page < 1 && $page = 1;
$limit < 6 && $limit = 6;
$result['list'] = page_fetch('book', getDoubanId($type),$_GET['type'], $page, $limit);
break;
    case 'movie':
...
$page < 1 && $page = 1;
$limit < 6 && $limit = 6;
$result['list'] = page_fetch('movie', getDoubanId($type),$_GET['type'], $page, $limit);
break;
    case 'music':
...
$page < 1 && $page = 1;
$limit < 6 && $limit = 6;
$result['list'] = page_fetch('music', getDoubanId($type),$_GET['type'], $page, $limit);
break;
}
