  ...
  <div class="aboutcard-main">
    <div class="aboutcard-section is-active" id="about">
      ...
      <div class="aboutcard-social">
             <?php if(!empty(Bsoptions('Github_URL')) || !empty(Bsoptions('Wechat_QRCODE')) || !empty(Bsoptions('QQ_QRCODE')) || !empty(Bsoptions('Facebook_URL')) || !empty(Bsoptions('Twitter_URL')) ||!empty(Bsoptions('Telegram_URL'))) :?>
    <div class="extra content center aligned">
       <?php if(!empty(Bsoptions('Github_URL'))) :?>
       
    <a href="<?php echo Bsoptions('Github_URL') ?>"<?php echo parselink(Bsoptions('Github_URL')); ?>><i class="github icon circular link" style="margin-bottom:10px"></i></a>
    <?php endif; ?>
    <?php if(!empty(Bsoptions('Wechat_QRCODE'))) :?>
    <a><i class="wechat icon circular link" style="margin-bottom:10px" id="contactwechat"></i></a>
    <?php endif; ?>
    <?php if(!empty(Bsoptions('QQ_QRCODE'))) :?>
    <a><i class="qq icon circular link" style="margin-bottom:10px" id="contactqq"></i></a>
    <?php endif; ?>
    <?php if(!empty(Bsoptions('Weibo_URL'))) :?>
    <a href="<?php echo Bsoptions('Weibo_URL') ?>"<?php if(Bsoptions('Link_blank') == '2'):?> target="_blank"<?php endif; ?>>
    <i class="weibo icon circular link" style="margin-bottom:10px"></i></a>
    <?php endif; ?>
    <?php if(!empty(Bsoptions('Facebook_URL'))) :?>
    <a href="<?php echo Bsoptions('Facebook_URL') ?>"<?php echo parselink(Bsoptions('Facebook_URL')); ?>>
    <i class="facebook icon circular link" style="margin-bottom:10px"></i></a>
    <?php endif; ?>
    <?php if(!empty(Bsoptions('Twitter_URL'))) :?>
    <a href="<?php echo Bsoptions('Twitter_URL') ?>"<?php echo parselink(Bsoptions('Twitter_URL')); ?>>
    <i class="twitter icon circular link" style="margin-bottom:10px"></i></a>
    <?php endif; ?>
    <?php if(!empty(Bsoptions('Telegram_URL'))) :?>
    <a href="<?php echo Bsoptions('Telegram_URL') ?>"<?php echo parselink(Bsoptions('Telegram_URL')); ?>>
