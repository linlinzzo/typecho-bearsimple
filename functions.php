...
当然，您要想前台能看到的话，请填写以下项，然后新建一个独立页面，并将自定义模板选择Memos',
        ...
        array(
            ...
            'type'     => 'text',
            'title'    => '您的Memos用户名',
            'after' => '填写您的Memos用户名，若不填则获取所有，但要注意的是数据量过大的情况下可能无法正常显示！',
        ),
        array(
            'type'    => 'heading',
            'content' => '微语模块',
    ...
    'fields' => array(
      array(
        ...
        array(
            ...
            'title'       => '人生进行时区块',
            'default' => false,
            'subtitle'=>'若选择开启,则网站右侧将出现人生进行时区块，动态显示今年-本月-今天的倒计时。'
        ),
        array(
            'id'      => 'AdControl',
            'type'    => 'switcher',
    ...
    'default'=>'baidu|https://www.baidu.com/',
        ...
        array(
         ...
         array(
            'type'    => 'notice',
            'style'   => 'info',
            'content' => '<h4><strong>服务使用说明</strong></h4><li>1、当前支持发送内容至微语或朋友圈，但需注意的是请选择好下方要发送内容的页面！</li><li>2、朋友圈：若选择的是朋友圈页面，发送“发朋友圈”四个字即可开启朋友圈模式，朋友圈模式中可发送混合图文内容，图片会存放在/usr/uploads/wechatServer/</li><li>3、微语：发送除了指定关键字外的任意文字都将发送到选择的微语页面</li><li>4、发送微语的方法与朋友圈是互通的，也就是说没有开启朋友圈模式下发送除了指定关键字外的任意文字也可以发送到朋友圈</li>',
        ),
        array(
            'id'          => 'wechat_service',
            'type'        => 'switcher',
