...
if($readerData):?>
<div class="ui four labels bearReader" style="text-align:center">
    <?php foreach($readerData as $reader):?>
  <a class="ui <?php echo $color[rand(0,count($color)-1)];?> image label">
  <img src="<?php echo imgravatarq($reader['mail']); ?>" loading="lazy" class="bearReader_Avatar">
  <?php echo $reader['author'];?> 
  <div class="detail"><?php echo $reader['num'];?> </div>
</a>
<?php endforeach;?>
