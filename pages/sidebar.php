...
<?php if($stat->publishedPostsNum > '99'){echo '99+';}else{echo $stat->publishedPostsNum();} ?>
    </a></div>
    <div class="label">
      文章
    </div>
   ...
   <div class="statistic">
            <div class="ui circular labels">
  <a class="ui label" style="margin-right:-2px">
      <?php if($stat->publishedCommentsNum - crossnum() > '99'){echo '99+';}else{echo $stat->publishedCommentsNum - crossnum();} ?>
     </a></div>
    <div class="label">
      评论 
    </div>
  ...
  <div class="statistic">
       <div class="ui circular labels">
  <a class="ui label" style="margin-right:-2px">
      <?php if($stat->categoriesNum > '99'){echo '99+';}else{echo $stat->categoriesNum();} ?>
   </a>
    </div>
    <div class="label">
      分类
  ...
  <div class="statistic">
    <div class="ui circular labels">
  <a class="ui label" style="margin-right:-2px">
      <?php if($stat->publishedPagesNum > '99'){echo '99+';}else{echo $stat->publishedPagesNum();} ?>
    </a></div>
    <div class="label">
      页面
    </div>
...
<form name="search" class="ui form" role="search" method="get" id="searchform">
  ...
  <div class="ui icon input" style="width:100%">
    ...
    <i class="search plus link icon"></i>
  </div>
</div>
