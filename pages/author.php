...
<div class="pure-g" id="layout">
  ...
  <div class="post_author-avatar"><img alt="<?php echo $this->getArchiveTitle(); ?>" <?php if(Bsoptions('Lazyload')== true): ?>class="lazyload lazyload-style-<?php echo $loader;?>"<?php endif; ?> <?php if(Bsoptions('Lazyload') == true): ?>src="data:image/svg+xml;base64,PCEtLUFyZ29uTG9hZGluZy0tPgo8c3ZnIHdpZHRoPSIxIiBoZWlnaHQ9IjEiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyIgc3Ryb2tlPSIjZmZmZmZmMDAiPjxnPjwvZz4KPC9zdmc+" <?php endif; ?> <?php if(Bsoptions('Lazyload') == true): ?> data-<?php endif; ?>src="<?php echo imgravatarq(getAuthorInfo($this->getArchiveSlug(),'mail')); ?>"></div>
